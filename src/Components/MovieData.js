export const moviesData = [
  ...
  {
    image:
      'https://m.media-amazon.com/images/M/MV5BOWNmNzdjYjQtZjIyOS00MDhiLTg4ZWUtZGZkZDE4ZDQwZTY1XkEyXkFqcGdeQXVyODk2ODI3MTU@._V1_.jpg',
    title: 'Forrest Gump',
    rating: 5,
    descrip:
  ...
  {
    image:
      'https://m.media-amazon.com/images/M/MV5BMDIzZWM5ZjctYjYxYS00NDNjLWI2Y2ItMmE1MWNiNWIxM2M1XkEyXkFqcGdeQXVyMTYzMDM0NTU@._V1_.jpg',
    title: 'Kingsman: The Secret Service',
    rating: 4,
    descrip:
      'A spy organisation recruits a promising street kid into the agencys training program, while a global threat emerges from a twisted tech genius.',
  },
  {
    image:
